(function () {
  ...
  const PLACEHOLDER_AVATAR = 'placeholder-avatar.svg?build=20260921145019';
  ...
  const WINTER_BREAK_START_DATE = addDays(TERM_DEFINITIONS.find((term) => term.id === UPPER_TERM_ID).end, 1);
  const WINTER_BREAK_END_DATE = addDays(TERM_DEFINITIONS.find((term) => term.id === GRADUATION_TERM_ID).start, -1);
  ...
  const MERGE_CHAINS = [
    {
      id: 1, name: '构思链', motherSvg: '1-0.svg?build=20260921145019', motherName: '构思',
      pieces: [
        { level: 1, svg: '1-1.svg?build=20260921145019', name: '灵感微光' },
        { level: 2, svg: '1-2.svg?build=20260921145019', name: '零散想法' },
        { level: 3, svg: '1-3.svg?build=20260921145019', name: '初步构思' },
        { level: 4, svg: '1-4.svg?build=20260921145019', name: '核心论点' },
        { level: 5, svg: '1-5.svg?build=20260921145019', name: '论文大纲' },
        { level: 6, svg: '1-6.svg?build=20260921145019', name: '引言初稿' },
        { level: 7, svg: '1-7.svg?build=20260921145019', name: '引言定稿' }
      ]
    },
    {
      id: 2, name: '文献链', motherSvg: '2-0.svg?build=20260921145019', motherName: '文献',
      pieces: [
        { level: 1, svg: '2-1.svg?build=20260921145019', name: '阅读闪念' },
        { level: 2, svg: '2-2.svg?build=20260921145019', name: '文献摘录' },
        { level: 3, svg: '2-3.svg?build=20260921145019', name: '综述片段' },
        { level: 4, svg: '2-4.svg?build=20260921145019', name: '文献综述' },
        { level: 5, svg: '2-5.svg?build=20260921145019', name: '理论框架' },
        { level: 6, svg: '2-6.svg?build=20260921145019', name: '方法初稿' },
        { level: 7, svg: '2-7.svg?build=20260921145019', name: '方法定稿' }
      ]
    },
    {
      id: 3, name: '实证链', motherSvg: '3-0.svg?build=20260921145019', motherName: '实证',
      pieces: [
        { level: 1, svg: '3-1.svg?build=20260921145019', name: '数据直觉' },
        { level: 2, svg: '3-2.svg?build=20260921145019', name: '实验记录' },
        { level: 3, svg: '3-3.svg?build=20260921145019', name: '分析图表' },
        { level: 4, svg: '3-4.svg?build=20260921145019', name: '结果汇总' },
        { level: 5, svg: '3-5.svg?build=20260921145019', name: '结果解读' },
        { level: 6, svg: '3-6.svg?build=20260921145019', name: '结果初稿' },
        { level: 7, svg: '3-7.svg?build=20260921145019', name: '结果定稿' }
      ]
    },
    {
      id: 4, name: '思辨链', motherSvg: '4-0.svg?build=20260921145019', motherName: '思辨',
      pieces: [
        { level: 1, svg: '4-1.svg?build=20260921145019', name: '讨论灵感' },
        { level: 2, svg: '4-2.svg?build=20260921145019', name: '批判笔记' },
        { level: 3, svg: '4-3.svg?build=20260921145019', name: '逻辑论证' },
        { level: 4, svg: '4-4.svg?build=20260921145019', name: '讨论要点' },
        { level: 5, svg: '4-5.svg?build=20260921145019', name: '结论雏形' },
        { level: 6, svg: '4-6.svg?build=20260921145019', name: '讨论初稿' },
        { level: 7, svg: '4-7.svg?build=20260921145019', name: '讨论定稿' }
      ]
    }
  ];
  ...
  const MERGE_BIZ_CHAINS = [
    {
      id: 1, name: '机会', motherSvg: 'g1-0.svg?build=20260921145019', motherName: '机会',
      pieces: [
        { level: 1, svg: 'g1-1.svg?build=20260921145019', name: '市场杂闻' },
        { level: 2, svg: 'g1-2.svg?build=20260921145019', name: '用户抱怨' },
        { level: 3, svg: 'g1-3.svg?build=20260921145019', name: '需求碎片' },
        { level: 4, svg: 'g1-4.svg?build=20260921145019', name: '目标用户画像' },
        { level: 5, svg: 'g1-5.svg?build=20260921145019', name: '需求验证报告' },
        { level: 6, svg: 'g1-6.svg?build=20260921145019', name: '市场规模预估' },
        { level: 7, svg: 'g1-7.svg?build=20260921145019', name: '市场分析篇' }
      ]
    },
    {
      id: 2, name: '产品', motherSvg: 'g2-0.svg?build=20260921145019', motherName: '产品',
      pieces: [
        { level: 1, svg: 'g2-1.svg?build=20260921145019', name: '产品想法' },
        { level: 2, svg: 'g2-2.svg?build=20260921145019', name: '功能清单' },
        { level: 3, svg: 'g2-3.svg?build=20260921145019', name: '核心功能原型' },
        { level: 4, svg: 'g2-4.svg?build=20260921145019', name: '价值主张' },
        { level: 5, svg: 'g2-5.svg?build=20260921145019', name: '最小可行产品计划' },
        { level: 6, svg: 'g2-6.svg?build=20260921145019', name: '技术路线图' },
        { level: 7, svg: 'g2-7.svg?build=20260921145019', name: '解决方案篇' }
      ]
    },
    {
      id: 3, name: '商业', motherSvg: 'g3-0.svg?build=20260921145019', motherName: '商业',
      pieces: [
        { level: 1, svg: 'g3-1.svg?build=20260921145019', name: '盈利点子' },
        { level: 2, svg: 'g3-2.svg?build=20260921145019', name: '收入来源列表' },
        { level: 3, svg: 'g3-3.svg?build=20260921145019', name: '成本结构分析' },
        { level: 4, svg: 'g3-4.svg?build=20260921145019', name: '定价策略' },
        { level: 5, svg: 'g3-5.svg?build=20260921145019', name: '客户关系策略' },
        { level: 6, svg: 'g3-6.svg?build=20260921145019', name: '核心伙伴设想' },
        { level: 7, svg: 'g3-7.svg?build=20260921145019', name: '商业模式篇' }
      ]
    },
    {
      id: 4, name: '执行', motherSvg: 'g4-0.svg?build=20260921145019', motherName: '执行',
      pieces: [
        { level: 1, svg: 'g4-1.svg?build=20260921145019', name: '创始初心' },
        { level: 2, svg: 'g4-2.svg?build=20260921145019', name: '团队雏形' },
        { level: 3, svg: 'g4-3.svg?build=20260921145019', name: '关键里程碑' },
        { level: 4, svg: 'g4-4.svg?build=20260921145019', name: '资源配置计划' },
        { level: 5, svg: 'g4-5.svg?build=20260921145019', name: '风险预案' },
        { level: 6, svg: 'g4-6.svg?build=20260921145019', name: '财务预测' },
        { level: 7, svg: 'g4-7.svg?build=20260921145019', name: '落地路线图' }
      ]
    }
  ];
  ...
  function getMergePieceInfo(chainId, level, petrified, mode = state.mergeGame?.mode) {
    const chain = getMergeChainMap(mode).get(chainId);
  ...
  function formatStoryContentHtml(value) {
    ...
    while ((match = pattern.exec(source)) !== null) {
      ...
      if (match[1] !== undefined || match[2] !== undefined || match[3] !== undefined) {
        ...
        html += `<span class="story-starred-inline">${escapeHtml(match[4])}</span>`;
      }
  ...
  function isDateInWinterBreak(dateText) {
    return dateText >= WINTER_BREAK_START_DATE && dateText <= WINTER_BREAK_END_DATE;
  }
  ...
  function normalizeTextPresetMode(value) {
    return value === 'builtin' ? 'builtin' : 'tavern';
  }

  function loadTextPresetModePreference(fallback = 'tavern') {
    const stored = loadJson(makeScopedKey(TEXT_PRESET_PREFERENCE_SCOPE), null);
    return normalizeTextPresetMode(stored?.mode ?? fallback);
  }

  function saveTextPresetModePreference(mode) {
    return saveJson(makeScopedKey(TEXT_PRESET_PREFERENCE_SCOPE), {
      mode: normalizeTextPresetMode(mode),
      savedAt: nowIso()
    });
  }
  ...
  function pruneStoredRuntimeRuleFields() {
    let changed = false;
    for (const scope of CHAT_STORAGE_SCOPES) {
      const key = makeScopedKey(scope);
      const stored = loadJson(key, null);
      const runtime = scope === 'runtime' ? stored : stored?.runtime;
      if (!runtime || typeof runtime !== 'object') continue;
      const before = JSON.stringify(stored);
      stripRuntimeRuleFields(runtime);
  ...
  async function waitForPreGenerationStorage(storagePromise, timeoutMs = PRE_GENERATION_STORAGE_WAIT_MS) {
    let timerId = null;
    const timeout = new Promise((resolve) => {
      timerId = window.setTimeout(() => resolve(false), timeoutMs);
    });
    try {
      return await Promise.race([
        Promise.resolve(storagePromise).then(() => true),
        timeout
      ]);
    } finally {
  ...
  function createRuntimeSnapshot(runtime) {
    ...
    stripRuntimeRuleFields(snapshot);
    return {
      snapshot,
  ...
  async function deleteReplacedImageFromIDB(entryKey, scope = 'runtime', namespace = 'tavern-card') {
    ...
    try {
      ...
      const completion = new Promise((resolve, reject) => {
        ...
        tx.onerror = () => reject(tx.error);
        tx.onabort = () => reject(tx.error || new Error('旧图片清理事务已中止。'));
      });
      // Delete both the current scoped entry and the unscoped key used by early
      // card builds. Manual and automatic save scopes remain historical snapshots.
      store.delete(`${makeImageScopePrefix(scope, namespace)}${normalizedEntryKey}`);
      store.delete(normalizedEntryKey);
      return await completion;
    } catch (error) {
      console.error('清理被替换的 IndexedDB 图片失败。', error);
      return false;
    }
  }

  function enqueueReplacedImageDeletion(entryKey, scope = 'runtime', namespace = 'tavern-card') {
    pendingImageWrites = pendingImageWrites
      .catch(() => true)
      .then(() => deleteReplacedImageFromIDB(entryKey, scope, namespace));
    return pendingImageWrites;
  }
  ...
  function waitForMergeGameIdleTurn(timeoutMs = 250) {
    if (state.ui.page !== 'merge-game' || typeof window === 'undefined') {
      return Promise.resolve();
    }
    return new Promise((resolve) => {
      if (typeof window.requestIdleCallback === 'function') {
  ...
  function renderBackgroundStateChange() {
    // 头像、礼服等后台状态不属于合成棋盘。玩家停留在小游戏时不重建
    // 整张棋盘；离开后正常的页面渲染会显示这些最新状态。
  ...
  function canRetryAvatarGeneration(character) {
    return !['queued', 'generating'].includes(String(character?.avatarStatus || ''));
  }

  function patchCharacterAvatarCard(characterId) {
    if (state.ui.page !== 'characters') {
      return;
    }
    const character = state.runtime?.characters.find((item) => item.id === characterId);
    const card = [...app.querySelectorAll('[data-character-card-id]')]
      .find((element) => element.dataset.characterCardId === characterId);
    if (!character || !card) {
      return;
    }
    const displayAvatarUrl = getCharacterDisplayAvatarUrl(character);
    const previewButton = card.querySelector('[data-action="open-character-image"]');
    const avatar = previewButton?.querySelector('.avatar');
    const retryButton = card.querySelector('[data-action="retry-avatar"]');
    const avatarGenerationReady = canRetryAvatarGeneration(character);
    if (avatar) {
      avatar.src = displayAvatarUrl;
    }
    if (previewButton) {
      previewButton.disabled = displayAvatarUrl === PLACEHOLDER_AVATAR;
    }
    if (retryButton) {
      retryButton.disabled = !avatarGenerationReady;
      retryButton.textContent = avatarGenerationReady ? '重新生成头像' : '头像生成中…';
    }
  }
  ...
  function patchRuntimeDefaults(runtime) {
    ...
    for (const [dateText, plan] of Object.entries(runtime.schedulePlans)) {
      ...
      hydrateSchedulePlanMetadata(runtime, dateText, plan);
    ...
    runtime.flags.internships.salaryPaidMonths = runtime.flags.internships.salaryPaidMonths && typeof runtime.flags.internships.salaryPaidMonths === 'object'
      ? runtime.flags.internships.salaryPaidMonths
      : {};
  ...
  function recoverInterruptedAssetJobs(runtime) {
    ...
    return { changed, interruptedCount };
  }
  ...
  function clearCurrentRuntime() {
    saveTextPresetModePreference(state.runtime?.meta?.textPresetMode);
  ...
  function buildWorldbookPromptSettings(runtime) {
    ...
    return {
      ...
      playerSettings: GAME_PROMPTS.buildPlayerSettings({
        ...
        cloth: '',
        playerDescription: runtime.meta?.playerDescription
      })
    };
  }
  ...
  function buildLoggedGenerateContentBody(payload) {
    ...
    const contents = [];
    const assistantInstructions = Array.isArray(options.assistantInstructions)
      ? options.assistantInstructions
      : (options.assistantInstruction ? [options.assistantInstruction] : []);
  ...
  function clearAiLoading() {
    ...
    if (state.ui.page === 'merge-game' && typeof document !== 'undefined') {
      const leaveButton = document.querySelector('.merge-leave-btn');
      if (leaveButton) {
        // AI 完成只改变离开按钮的提示光效，不再替换棋盘 DOM。整盘重绘
        // 会中断正在进行的拖拽，并造成玩家可感知的布局和图片解码卡顿。
        leaveButton.classList.add('merge-leave-glow');
        return;
      }
    }
    render();
  ...
  async function executeAiRequest(label, endpoint, payload, options = {}) {
    ...
    if (AI_DISABLED) {
      ...
      if (shouldBlock) setAiLoading(loadingMsg);
      await sleep(10000);
      if (shouldBlock && !options.keepLoading) clearAiLoading();
      const mockOutput = {
        output: {
          textParts: [
    ...
    try {
      ...
      if (created?.output || created?.raw) {
        ...
        await waitForMergeGameIdleTurn();
      ...
      if (shouldBlock && !options.keepLoading) {
        clearAiLoading();
      }
    }
  }
  ...
  function getStoryLoadingMessage(eventName) {
    if (IS_TEST_BUILD) {
      return `正在编写剧情：${eventName}`;
    }
    const isDateStoryEvent = [
      '约会事件',
      '第一次三人约会事件',
      '三人约会事件'
    ].includes(eventName);
    return isDateStoryEvent
      ? '正在编写剧情，请稍候… 要去约会放松了'
      : '正在编写剧情，请稍候…';
  }
  ...
  function syncSchedulePlansWithBootstrap(runtime) {
    ...
    for (const [dateText, plan] of Object.entries(runtime.schedulePlans)) {
      ...
      const fixed = isLockedScheduleActivity(activity, plan);
  ...
  function isLockedScheduleActivity(activity, existingPlan = null) {
    return LOCKED_SCHEDULE_ACTIVITIES.has(activity)
      || (activity === '班级度假' && existingPlan?.fixed === true);
  }
  ...
  function hydrateSchedulePlanMetadata(runtime, dateText, plan) {
    if (!plan || typeof plan !== 'object' || plan.cleared) return plan;
    delete plan.specKey;
    if (['course', 'homework', 'review'].includes(plan.kind)) {
      const courseName = String(runtime.courses?.[plan.courseId]?.courseName || '');
      const prefixes = { course: '上', homework: '写', review: '复习' };
      const suffix = plan.kind === 'homework' ? '的作业' : '';
      plan.label = `${prefixes[plan.kind]}${courseName}${suffix}`;
    } else if (plan.kind === 'date') {
      const character = runtime.characters?.find((item) => item.id === plan.characterId);
      plan.label = `与${character?.name || '某人'}约会`;
    } else if (plan.kind === 'activity' || plan.kind === 'exam') {
      const activity = normalizeActivityLabel(plan.activity || plan.label || getFixedActivity(dateText) || (plan.kind === 'exam' ? '考试' : ''));
      ...
      const labels = {
        flyer: '发传单',
        tutor: '做家教',
        'student-secretary': '做学生会秘书',
        assistant: '做助教',
        sleep: '睡觉',
        'winter-job': '新年礼宾临时工',
        'graduation-internship': '毕业实习',
        'graduation-thesis': '写毕业论文',
        'debate-prep': '准备校际辩论会'
      };
      plan.label = labels[plan.kind] || String(plan.label || '');
    }
    plan.specKey = getActionGroup(plan);
    return plan;
  }
  ...
  function lockClassTripWeekAfterStart(runtime, dateText, weekDates = getWeekDates(dateText)) {
    const currentPlan = runtime?.schedulePlans?.[dateText];
    const currentActivity = normalizeActivityLabel(currentPlan?.activity || currentPlan?.label || '');
    if (dateText !== weekDates[0] || currentActivity !== '班级度假') {
      return false;
    }

    let changed = false;
    for (const day of weekDates) {
      const existingPlan = runtime.schedulePlans[day];
      const completed = Boolean(existingPlan?.completed);
      if (
        !existingPlan
        || existingPlan.cleared
        || existingPlan.kind !== 'activity'
        || normalizeActivityLabel(existingPlan.activity || existingPlan.label || '') !== '班级度假'
        || existingPlan.fixed !== true
      ) {
        changed = true;
      }
      runtime.schedulePlans[day] = {
        ...(existingPlan || {}),
        cleared: false,
        kind: 'activity',
        label: '班级度假',
  ...
  function getAvailableActions(runtime, dateText) {
    ...
    if (currentTerm && !currentTerm.isBreak) {
      ...
      if (!termFinalized && !isAfterTermExams({ dateText, termId: effectiveTermId, activities: getScheduleActivities() })) {
    ...
    for (const graduationActionKind of getGraduationActionKinds({
      termId: currentTerm?.id,
      isWeekend: isWeekend(dateText)
    })) {
      const graduationAction = buildActionFromToken(runtime, dateText, graduationActionKind);
      if (graduationAction) actions.push(graduationAction);
    }
  ...
  function isRuleAddedIdentityLabel(label) {
    ...
    return [
      ...
      '实习上司',
      '企业高管'
    ].includes(normalized) || /^.+课(?:教授|学生)$/.test(normalized);
  }

  function getCharacterSummary(character) {
    if (Object.prototype.hasOwnProperty.call(character || {}, 'displayIdentity')) {
      return String(character.displayIdentity || '').trim();
    }
    const identityParts = String(character?.identity || '')
      .split('、')
      .map((item) => item.trim())
      .filter(Boolean);
    while (identityParts.length > 1 && isRuleAddedIdentityLabel(identityParts.at(-1))) {
      identityParts.pop();
    }
  ...
  function patchCharacterDefaults(rawCharacter) {
    const identity = String(rawCharacter['身份'] || '').trim();
    return {
      ...
      favorability: 0,
      isLover: false,
      socialDynamics: String(rawCharacter['性格动力与社交类型'] || '').trim(),
      speechStyle: String(rawCharacter['说话方式与台词示例'] || '').trim(),
      bio: String(rawCharacter['人物小传'] || '').trim(),
      traits: String(rawCharacter['核心特质'] || '').trim(),
      familyPosition: String(rawCharacter['在家族企业或政府部分的职位'] || '').trim(),
  ...
  function parseEventOutput(text) {
    ...
    if (!content || !newHistory) {
      const missing = [!content && '<content>', !newHistory && '<newHistory>'].filter(Boolean);
      throw new Error(`AI 返回缺少必要标签或标签内容为空：${missing.join('、')}。\n已收到 ${sanitizedText.length} 字符；请检查这些标签是否成对闭合。完整回复保留在酒馆模型楼层。`);
    }
  ...
  async function applyTavernDisplayRegex(text) {
    // 仅酒馆预设模式在标签解析后调用；只清理正文，不处理原文或履历等数据。
  ...
  function isCurrentSchoolProfessor(character) {
    ...
    return affiliation.includes('本校教授')
  ...
  function formatCharacterRomanceKnowledge(runtime, character) {
    const isTrioParticipant = Boolean(character?.eventFlags?.global?.['三人约会参与者']);
    if (isTrioParticipant) {
      const otherParticipant = runtime.characters.find((item) => (
        item.id !== character.id
        && item?.eventFlags?.global?.['三人约会参与者']
      ));
      if (otherParticipant) {
        return `他知道<user>的恋人除了他还有${otherParticipant.name}，除此以外他不知道<user>有其他恋人`;
      }
    }
    if (character.isLover) {
      return '他知道自己是<user>的恋人，不知道<user>是否有其他恋人';
    }
    return '他不清楚<user>是否有恋人';
  }
  ...
  function formatCharactersForPrompt(runtime, characterIds = []) {
    ...
    return characterIds
      ...
      .map((character) => [
        ...
        `在家族企业或政府部分的职位：${character.familyPosition || '无'}`,
        `爱好：${character.hobbies || '无'}`,
        `住所：${character.home || '无'}`,
        `性爱偏好：${character.sexualPreference || '无'}`,
        `阴茎描述：${character.penisDescription || '无'}`,
        `对<user>情感状况的了解：${formatCharacterRomanceKnowledge(runtime, character)}`
      ].join('\n'))
      .join('\n\n');
  }
  ...
  function formatChaptersForPrompt(runtime) {
    ...
    return chapters.map((chapter) => {
      const history = runtime.history.find((item) => item.index === chapter.historyIndex);
      return [
        `<info_block>\n${chapter.infoBlock || ''}\n</info_block>`,
        // 按游戏约定复用过滤后的正文，再由程序补回协议标签作为前文范例。
        `<content>\n${chapter.displayContent ?? chapter.content ?? ''}\n</content>`,
        `<newHistory>\n${history?.text || ''}\n</newHistory>`
      ].join('\n');
    });
  }
  ...
  function resolveEventCharacterIds(runtime, eventName, dateText, options = {}) {
    ...
    if (rule === '全部已有角色' || rule === '所有角色') {
      return uniqueCharacterIds(runtime.characters.map((character) => character.id));
    }
    ...
    if (rule.includes('这些角色里有这次的舞伴')) {
      const attendanceAffiliations = rule.includes('杰出校友')
        ? ['本校学生', '本校老师', '杰出校友']
        : ['本校学生', '本校老师'];
      const attendeeIds = getCharactersByAffiliations(runtime, attendanceAffiliations).map((character) => character.id);
      return uniqueCharacterIds([...explicitIds, ...attendeeIds]);
    }
    ...
    if (rule.includes('所有本校学生，本校老师，杰出校友')) {
      return uniqueCharacterIds(getCharactersByAffiliations(runtime, ['本校学生', '本校老师', '杰出校友']).map((character) => character.id));
    }
    if (rule.includes('所有本校学生，本校老师')) {
      return uniqueCharacterIds(getCharactersByAffiliations(runtime, ['本校学生', '本校老师']).map((character) => character.id));
    }
    if (rule === '所有本校教授') {
      return uniqueCharacterIds(runtime.characters.filter(isCurrentSchoolProfessor).map((character) => character.id));
    }
    ...
    if (rule.includes('所有本校学生')) {
      return uniqueCharacterIds(getCharactersByAffiliations(runtime, ['本校学生']).map((character) => character.id));
    }
  ...
  function buildMultiCharacterRomancePromptLine(eventName, eventSpec, context) {
    if (String(eventName || '').includes('三人约会')) {
      return '';
    }
    const characters = Array.isArray(context?.characters) ? context.characters : [];
    const characterRule = String(eventSpec?.characters || '');
    const isFixedGroupScene = /舞会|晚宴|拍卖会/.test(String(eventName || ''));
    const isPluralCharacterRule = !characterRule.includes('任选一人') && (
      characterRule.includes('所有')
      || characterRule.includes('全部')
      || characterRule.includes('两个人')
      || characterRule.includes('两个')
      || characterRule.includes('和随机的另一个')
      || characterRule.includes('家教学生和家教学生的家长')
      || characterRule.includes('实习上司，除了实习上司外')
    );
    if (characters.length < 2 && !isFixedGroupScene && !isPluralCharacterRule) {
      return '';
    }
    return '如果<user>有多个恋人，在这种多人场合确保在合理的情况下让<user>没有在进行任何刻意隐瞒的情况下，没有被人看出她在劈腿的事。但注意角色和<user>是恋人的情况下彼此不会用生疏的正式的称呼来称呼彼此，还是要保持有亲密感的语气。';
  }

  function buildGroupEventAttendancePromptLine(runtime, eventName, context) {
    const normalizedEventName = String(eventName || '');
    const isRestrictedGroupEvent = /校庆晚宴|慈善拍卖会|新年舞会|假面舞会/.test(normalizedEventName)
      || /^(?:参观马术障碍赛|班级度假|春游野餐会|校园音乐节|第一次准备校际辩论会|准备校际辩论会)事件$/.test(normalizedEventName)
      || /^第[一二三四]场辩论(?:胜利|失败)事件$/.test(normalizedEventName);
    if (!isRestrictedGroupEvent) {
      return '';
    }
    const attendeeNames = getCharactersFromIds(runtime, context?.sceneCharacterIds || [])
      .map((character) => String(character.name || '').trim())
      .filter(Boolean);
    const namesText = attendeeNames.length ? attendeeNames.join('，') : '暂无已认识的角色';
    return `参加这个场合的人有${namesText}，注意除此以外的其他人并不在场。`;
  }
  ...
  function buildEventPrompt(runtime, dateText, eventName, options = {}) {
    ...
    const promptContextLines = [
      ...
      buildMultiCharacterRomancePromptLine(eventName, eventSpec, context)
    ].filter(Boolean);
    if (options.extraPrompt) {
      promptContextLines.push(String(options.extraPrompt).trim());
    }
    const attendancePromptLine = buildGroupEventAttendancePromptLine(runtime, eventName, context);
    if (attendancePromptLine) {
      promptContextLines.push(attendancePromptLine);
    }
...
${promptContextLines.join('\n')}`;
    ...
    return {
      ...
      assistantInstructions: promptTexts.assistantInstructions,
  ...
  function waitForLoverOutfitChoice(lovers) {
    return new Promise((resolve) => {
      openModal({
  ...
  function waitForErrorRetryModal(title, message) {
    return new Promise((resolve) => {
      ...
      showModalAfterMergeExit(() => openModal(modal));
    });
  }
  ...
  function formatAiErrorMessage(error) {
    ...
    if (/\b429\b|RESOURCE_EXHAUSTED|Too Many Requests/i.test(message)) {
      return `${message}\n\n说明：上游模型当前触发限流或资源繁忙。本次不会自动重发，请稍后点击“重试”手动重新发送。`;
    }
  ...
  function waitForChapterModal(chapterId) {
    ...
    return new Promise((resolve) => {
      ...
      showModalAfterMergeExit(showChapterConfirm);
    });
  }

  function showModalAfterMergeExit(showModal) {
    if (state.ui.page === 'merge-game') {
      // 成功章节和失败重试都走同一个出口：小游戏中不打断玩家，
      // 离开小游戏后再显示本来应该出现的弹框。
      state.pendingMergeExitModalShow = showModal;
      return;
    }
    showModal();
  }
  ...
  async function runStorageOperation(message, operation) {
    if (state.ui.storageLoading) {
      return false;
    }
    state.ui.storageLoading = { message };
    render();
    await waitForBlockingOverlayPaint();
    try {
      return await operation();
    } finally {
      state.ui.storageLoading = null;
      render();
    }
  }
  ...
  async function queueCharacterAvatarGeneration(characterId) {
    ...
    try {
      ...
      await waitForMergeGameIdleTurn();
      saveCurrentRuntime();
      patchCharacterAvatarCard(characterId);
      return false;
    }
    ...
    const timerId = window.setTimeout(() => {
      ...
      enqueueAssetGenerationTask(`avatar:${characterId}`, async () => {
        ...
        await waitForMergeGameIdleTurn();
        const runtimeSaved = saveCurrentRuntime();
        // Do not expose the replacement avatar as finished until the current
        // runtime snapshot has also reached the chat-bound durable storage.
        // Otherwise an immediate page refresh can hydrate the previous avatar
        // from the still-stale chat variable and overwrite the local update.
        await flushChatStorage().catch(() => null);
        if (generatedImageSaved && runtimeSaved) {
          await enqueueReplacedImageDeletion(`char:${characterId}`);
        }
        patchCharacterAvatarCard(characterId);
      });
    }, 100);
  ...
  async function queueOutfitImageGeneration(outfitId) {
    ...
    const timerId = window.setTimeout(() => {
      ...
      enqueueAssetGenerationTask(`outfit:${outfitId}`, async () => {
        ...
        await waitForMergeGameIdleTurn();
        const runtimeSaved = saveCurrentRuntime();
        // Outfit images use the same background persistence path as avatars;
        // keep their refresh behavior consistent as well.
        await flushChatStorage().catch(() => null);
        if (generatedImageSaved && runtimeSaved) {
          await enqueueReplacedImageDeletion(`outfit:${outfitId}`);
        }
        renderBackgroundStateChange();
      });
    }, 100);
  ...
  async function applyEventResult(runtime, dateText, parsed, eventSpec, context, rawResponse, promptText, options = {}) {
    // 剧情解析完成后可能紧接着进行大存档序列化。小游戏运行中把这段
    // 工作交给浏览器空闲时段，优先响应当前的点击和拖拽。
    await waitForMergeGameIdleTurn();
    ...
    const loverOutfitGiver = options.loverOutfitGiverCharacterId
      ? runtime.characters.find((character) => character.id === options.loverOutfitGiverCharacterId)
      : null;
    if (loverOutfitGiver) {
      updateCharacterFavorability(loverOutfitGiver, 4);
    }
    syncTutorCharacterIds(runtime, parsed.newCharacters || []);

    const historyIndex = addHistory(runtime, dateText, parsed.newHistory);
    const chapterId = addChapter(runtime, dateText, parsed.infoBlock, parsed.content, historyIndex, parsed.displayContent);
    runtime.meta.pendingStoryEvent = {
      ...(runtime.meta.pendingStoryEvent || {}),
    ...
    saveCurrentRuntime();
    // 立即进入原有串行保存队列；本机已有 ready 章节，阅读就绪不等待跨设备同步。
    void (async () => {
      try {
        await flushChatStorage();
      } catch (error) {
        // 正文和效果已落入本机存档，云端同步失败不能丢弃剧情或重新生成。
        setStatus(`剧情已生成，但同步酒馆存档失败：\n${error.message || error}`, 'error');
      }
    })();
  ...
  async function persistPendingStoryEvent(eventName, dateText, options, status, extra = {}, flush = true, beforeFlush = null) {
    if (!state.runtime) {
      return;
    }
    const previousPending = state.runtime.meta.pendingStoryEvent;
    state.runtime.meta.pendingStoryEvent = {
      ...
      error: '',
      chapterId: '',
      dayPlanCommitted: previousPending?.dayPlanCommitted === true,
      updatedAt: nowIso(),
      ...extra
    };
    saveCurrentRuntime();
    if (typeof beforeFlush === 'function') beforeFlush();
    if (flush) await flushChatStorage();
  }

  function commitInterruptedStoryDayPlan(pending) {
    const runtime = state.runtime;
    const dateText = pending?.dateText;
    const plan = dateText ? runtime?.schedulePlans?.[dateText] : null;
    if (!runtime || !plan || plan.completed) {
      return false;
    }
    const isLegacyInterruptedDay = pending.dayPlanCommitted === undefined
      && runtime.phase === 'playing'
      && runtime.player.currentDate === dateText;
    if (pending.dayPlanCommitted !== true && !isLegacyInterruptedDay) {
      return false;
    }
    plan.completed = true;
    const weekDates = getWeekDates(dateText);
    state.ui.selectedDate = weekDates.find((item) => !isDateCompleted(runtime, item)) || dateText;
    saveCurrentRuntime();
    return true;
  }

  function applyRecoveredStoryContinuation(pending) {
    const fatigueRestStoryEvents = [
      '约会事件',
      '第一次三人约会事件',
      '三人约会事件',
      '有钱看病版认识校外人士事件',
    ...
    const recoveryAction = pending?.options?.recoveryAction;
    const shouldClearFatigue = recoveryAction === 'clear-fatigue-after-story'
      || recoveryAction === 'hospital-rest-after-story'
      || fatigueRestStoryEvents.includes(pending?.eventName);
    if (!shouldClearFatigue || !state.runtime) {
      return false;
    }
    updatePlayerFatigue(state.runtime, -state.runtime.player.fatigue);
    saveCurrentRuntime();
    render();
    return true;
  }
  ...
  function restorePendingStoryEventUi() {
    ...
    commitInterruptedStoryDayPlan(pending);
    ...
    if (pending.status === 'ready') {
      ...
      if (chapter) {
        ...
        state.ui.modal = {
          ...
          scrollTop: 0,
          resolver: () => applyRecoveredStoryContinuation(pending)
        };
        saveChapterModalState(state.ui.modal);
        return true;
      }
    ...
    state.ui.modal = {
      ...
      onRetry: async () => {
        ...
        applyRecoveredStoryContinuation(recoveryPending);
      }
    };
    return true;
  }
  ...
  async function recoverPendingStoryEventResponse() {
    ...
    try {
      ...
      const textPresetMode = (pending.textPresetMode ?? state.runtime?.meta?.textPresetMode) === 'builtin' ? 'builtin' : 'tavern';
      const payload = buildAiPayload(eventPrompt.prompt, {
        options: {
          textPresetMode,
          playerName: state.runtime?.player?.name,
          ...
          assistantInstructions: eventPrompt.assistantInstructions,
      ...
      try {
        ...
        if (/缺少必要标签/.test(String(error?.message || ''))) {
          throw new Error(`${error.message}\n\n本次读取的是刷新前保存的回复。若该回复当时已经缺失标签，刷新无法补回，请重试生成。`);
        }
        throw error;
      }
    ...
    while (true) {
      ...
      try {
        ...
        const activeDayPlan = Array.isArray(state.ui.deferredChapterIds)
          ...
          : null;
        const dayPlanCommitted = Boolean(activeDayPlan && !activeDayPlan.completed);
        if (dayPlanCommitted) {
          activeDayPlan.completed = true;
        }
        const loadingMessage = getStoryLoadingMessage(eventName);
        stage = '保存生成前进度';
        const pendingStorage = persistPendingStoryEvent(eventName, dateText, options, 'generating', { dayPlanCommitted, recoveryId, textPresetMode }, true, () => {
          state.ui.currentAiEvent = eventName;
          setAiLoading(loadingMessage);
        });
        const pendingStorageSaved = await waitForPreGenerationStorage(pendingStorage);
        if (!pendingStorageSaved) {
          setStatus('生成前的酒馆跨设备存档暂未完成；本机恢复点已保留，正在继续请求 AI。生成结束前请勿切换设备。', 'warning');
        }
        stage = '请求 AI 并写入酒馆楼层';
        ...
        try {
          ...
          if (/缺少必要标签/.test(String(error?.message || ''))) {
            const sourceNote = result.raw?.responseSource === 'network'
              ? '来源诊断：已直接读取本次接口返回正文，但其中仍缺少必要标签或内容；请检查发送的提示词与接口输出。'
              : result.raw?.responseSource === 'chat_backup'
                ? '来源诊断：目前读取的是本次已保存的独立回复，其中仍缺少必要标签或内容；该备份不代表接口最底层原文。'
                : '来源诊断：未能直接捕获本次接口原文，目前读到的是酒馆助手返回值；仍可能被回复处理脚本或正则改写。';
            throw new Error(`${error.message}\n\n${sourceNote}`);
          }
          throw error;
        }
  ...
  async function executeActivity(runtime, plan, dateText) {
    ...
    switch (label) {
      ...
      case '毕业答辩':
        {
          const professors = runtime.characters.filter(isCurrentSchoolProfessor);
          const professorNames = professors.map((character) => character.name).filter(Boolean).join('、') || '暂无已记录的本校教授';
          await executeStoryEvent('毕业答辩事件', dateText, {
            characterIds: professors.map((character) => character.id),
            replacements: { '（这里列入所有本校教授的名字）': professorNames }
          });
        }
        break;
      case '参加毕业典礼':
  ...
  async function executeCourse(runtime, plan, dateText) {
    ...
    if (!runtime.flags.courseFirstClassDone[plan.courseId]) {
      ...
      const hasKnownAssistant = hasTriggeredEvent(runtime, '认识助教事件');
      const hasKnownProfessor = hasTriggeredEvent(runtime, '认识教授事件');
    ...
    const classmateProbability = hasTriggeredEvent(runtime, '认识同学事件') ? 0.01 : 0.2;
    const classroomEventRoll = Math.random();
    if (classroomEventRoll < classmateProbability) {
    ...
    if ([...professorIds, ...assistantIds, ...classmateIds].length && classroomEventRoll < classmateProbability + 0.15) {
  ...
  async function executeReview(runtime, plan, dateText) {
    ...
    const strangerEncounterProbability = hasTriggeredEvent(runtime, '图书馆偶遇陌生人事件') ? 0.05 : 0.3;
    const libraryEncounterRoll = Math.random();
    if (libraryEncounterRoll < strangerEncounterProbability) {
      await executeStoryEvent('图书馆偶遇陌生人事件', dateText, { characterIds: runtime.characters.map((item) => item.id) });
      return;
    }
    if (runtime.characters.length && libraryEncounterRoll < strangerEncounterProbability + 0.3) {
  ...
  async function executeFlyer(runtime, dateText) {
    ...
    const hasMetFlyerContact = hasTriggeredEvent(runtime, '发传单认识陌生人事件');
    const flyerEventRoll = Math.random();
    if (!hasMetFlyerContact && flyerEventRoll < 0.5) {
      await executeStoryEvent('发传单认识陌生人事件', dateText, { characterIds: runtime.characters.map((item) => item.id) });
      return;
    }
    if (hasMetFlyerContact && flyerEventRoll < 0.25) {
      await executeStoryEvent('和发传单认识的人互动事件', dateText, { characterIds: runtime.characters.map((item) => item.id) });
      return;
    }
    if (hasMetFlyerContact && runtime.characters.length && flyerEventRoll < 0.5) {
  ...
  async function executeWinterJob(runtime, dateText) {
    ...
    if (!hasTriggeredEvent(runtime, '寒假百货礼宾打工事件')) {
  ...
  async function executeAssistant(runtime, dateText) {
    ...
    const assistantEventRoll = Math.random();
    if (professor && assistantEventRoll < 0.2) {
    ...
    const hasMetAssistantJunior = hasTriggeredEvent(runtime, '当助教认识学弟事件');
    if (!hasMetAssistantJunior && assistantEventRoll >= 0.2 && assistantEventRoll < 0.5) {
    ...
    if (hasMetAssistantJunior && assistantEventRoll >= 0.2 && assistantEventRoll < 0.4) {
  ...
  async function executeDate(runtime, plan, dateText) {
    ...
    if (character) {
      updateCharacterFavorability(character, randomInt(10, 20));
      ...
      if (character.isLover && lovers.length >= 2 && !hasTriggeredEvent(runtime, '第一次三人约会事件') && chance(0.05)) {
        ...
        if (otherLover) {
          ...
          await executeStoryEvent('第一次三人约会事件', dateText, {
            deferChapterModal: false,
            recoveryAction: 'clear-fatigue-after-story',
  ...
  async function executeInternship(runtime, dateText, locationText) {
    ...
    if (getCharactersByRelation(runtime, (item) => item.isLover).length && chance(0.3)) {
  ...
  function payMonthlyInternshipSalary(runtime, dateText) {
    const paidMonths = runtime.flags.internships.salaryPaidMonths;
    if (!shouldPayInternshipSalary({
      dateText,
      internship: runtime.player.graduationInternship,
      paidMonths
    })) {
      return 0;
    }
    const monthKey = getMonthKey(dateText);
    const salary = getInternshipSalaryAmount({ dateText });
    const salaryLabel = monthKey === CAMPAIGN_CONFIG.graduationTermStartDate.slice(0, 7) ? '首月半月薪' : '月薪';
    paidMonths[monthKey] = dateText;
    updatePlayerMoney(runtime, salary);
    addHistory(runtime, dateText, `${formatHistoryDatePrefix(dateText)}，${runtime.player.name}收到了毕业实习${salaryLabel} ${salary} 元。`);
    return salary;
  }
  ...
  async function runPostPlanAddDaySteps(runtime, dateText) {
    const plan = getPlanForDate(runtime, dateText);
    if (normalizeActivityLabel(plan?.activity || plan?.label || '') === '参加毕业典礼') {
      return;
    }
  ...
  async function executeAddDay(runtime, dateText, weekDates) {
    ...
    const chapterCountBeforeDay = runtime.chapters.length;
    ...
    if (lockClassTripWeekAfterStart(runtime, dateText, weekDates)) {
      // 第一天开始后整周行程不可反悔；先本地落盘，确保刷新或剧情失败也不会解除锁定。
      saveCurrentRuntime();
    }
    ...
    try {
      ...
      payMonthlyInternshipSalary(runtime, dateText); // 月末统一发放实习工资，不按实习天数结算

      saveCurrentRuntime();
      render();
      var hadChapter = runtime.chapters.length > chapterCountBeforeDay;
  ...
  async function executeCurrentWeek() {
    ...
    closeModal();
    render();
    let shouldFlushChatStorage = false;
    try {
      const executedDates = [];
      ...
      if (!savedRuntime || !savedAuto) {
        ...
        shouldFlushChatStorage = true;
      }
    } finally {
      // 日期推进和本机存档已经完成后，先恢复新一周的界面。跨设备同步可能
      // 因酒馆桥接响应缓慢而长时间等待，但不应继续锁住整页交互。
      state.ui.interactionLocked = false;
      render();
    }
    if (shouldFlushChatStorage) {
      await flushChatStorage();
    }
  }
  ...
  function hydrateMergeTask(mode, task) {
    const source = task && typeof task === 'object' ? task : {};
    const isBusinessTask = mode === 'biz';
    const courseId = isBusinessTask ? null : source.courseId;
    const course = courseId ? state.runtime?.courses?.[courseId] : null;
    const requiredPieces = (Array.isArray(source.requiredPieces) ? source.requiredPieces : [])
      .map((piece) => {
        const chainId = Number(piece?.chainId);
        const level = Number(piece?.level);
        const info = getMergePieceInfo(chainId, level, false, mode);
        return info ? { chainId, level, svg: info.svg, name: info.name } : null;
      })
      .filter(Boolean);
    return {
      ...source,
  ...
  function initMergeGame(mode) {
    ...
    const hasSavedBoard = saved && Array.isArray(saved.board) && saved.board.length === MERGE_BOARD_SIZE;
    if (shouldStartTutorial && hasSavedBoard && saved.tutorial && typeof saved.tutorial === 'object') {
      ...
      state.mergeGame.tasks = Array.isArray(saved.tasks) ? saved.tasks.map((task) => hydrateMergeTask(mode, task)) : [];
      ...
      state.mergeGame.tasks = [{
        courseId: null,
        courseName: '创业企划书',
        requiredPieces: [{ chainId: 1, level: 2, svg: 'g1-2.svg?build=20260921145019', name: '用户抱怨' }]
      }];
      ...
      if (Array.isArray(saved.tasks) && saved.tasks.length) {
        state.mergeGame.tasks = cleanupStaleMergeTasks(mode, saved.tasks.map((task) => hydrateMergeTask(mode, task)));
      }
      if (!state.mergeGame.tasks.length) {
        refreshMergeTasks();
      }
  ...
  function submitMergeTask(taskIndex) {
    const mg = state.mergeGame;
    const runtime = state.runtime;
    // The submitted pieces stay on the board for the 500 ms fly animation.
    // Lock the whole submission path during that window so rapid clicks cannot
    // award progress repeatedly or let a queued timeout reroll a later task.
    if (!mg || !runtime || mg.submitAnimation) return;
  ...
  function leaveMergeGame() {
    ...
    function finishLeave() {
      const showPendingModal = state.pendingMergeExitModalShow;
      const resumeDueWeek = state._dueMergeGuard;
      state.pendingMergeExitModalShow = null;
      state._dueMergeGuard = null;
      state.ui.page = 'schedule';
      // 强制作业小游戏属于仍在执行中的周结算。先恢复结算链，再由
      // executeCurrentWeek 在日期推进完成后一次性渲染，避免短暂显示
      // “旧周 + 全页锁定”并在远程存档迟迟不返回时永久停在那里。
      if (resumeDueWeek) {
        resumeDueWeek();
      }
      if (showPendingModal) {
        showPendingModal();
      } else if (!resumeDueWeek) {
        render();
      }
    }
    if (container) {
  ...
  function renderMergeGameContent() {
    ...
    if (mg.tasks.length) {
      ...
      tasksHtml = `<div class="merge-tasks${tasksTutorialClass}">${mg.tasks.map((task, ti) => {
        const canSubmit = !mg.submitAnimation && canSubmitTask(task);
        let progressHtml = '';
        if (isBiz) {
      ...
      <div class="panel section">
        ...
        <div class="character-list" style="margin-top:18px;">
          ${runtime.characters.length ? runtime.characters.map((character) => {
            ...
            const avatarGenerationReady = canRetryAvatarGeneration(character);
            return `
              <div class="character-card" data-character-card-id="${character.id}">
  ...
  function renderSystemPage() {
    ...
    const textPresetMode = state.runtime?.meta?.textPresetMode === 'builtin' ? 'builtin' : 'tavern';
    const playerDescription = state.ui.playerDescriptionDraft
      ?? state.runtime?.meta?.playerDescription
      ?? GAME_PROMPTS.defaultPlayerDescription;
    return `
      <div class="panel section">
        <div class="topbar">
          <div>
        ...
        ${state.ui.status ? `<div class="status ${state.ui.statusTone || ''}" role="status" style="margin-top:12px;white-space:pre-wrap;">${escapeHtml(state.ui.status)}</div>` : ''}
        ...
        <div class="muted-box" style="margin-top:12px;">
          ...
          <div class="subtle" style="margin-top:8px;">
            酒馆当前预设模式将使用您当前的酒馆预设。由于该游戏对格式要求很高，不能适配所有预设，如果酒馆当前预设掉格式太厉害请换用游戏内置预设模式。游戏内置预设将无视您自己的预设和世界书。
          </div>
        </div>
        <div class="muted-box" style="margin-top:12px;">
          <label for="playerDescription"><strong>主角身份与性格</strong></label>
          <div class="subtle" style="margin:8px 0;">
            这里只修改主角设定 Prompt 中的身份和性格两行。&lt;user&gt; 会替换成当前主角名；生日、年龄、年级、服装等仍由游戏填写。保存后两种文字预设的后续剧情及手动导出的世界书都会使用新内容。
          </div>
          <textarea id="playerDescription" rows="7" spellcheck="false" aria-label="主角身份与性格">${escapeHtml(playerDescription)}</textarea>
          <div class="inline-actions" style="margin-top:10px;">
            <button class="primary" data-action="save-player-description">保存主角设定</button>
            <button class="secondary" data-action="reset-player-description">恢复默认并保存</button>
          </div>
        </div>
  ...
  function renderModal() {
        ...
        <div class="modal-backdrop">
          <div class="modal" data-chapter-id="${escapeHtml(modal.chapterId || modal.chapter.id)}">
            <div class="modal-body">
              <div class="story-content">${formatStoryContentHtml(modal.chapter.displayContent ?? modal.chapter.content)}</div>
    ...
    if (modal.type === 'lover-outfit-picker') {
      return `
        <div class="modal-backdrop">
          <div class="modal">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <div class="action-list">
                ${modal.characters.map((character) => `
                  <button class="action-card action-picker-button" data-action="select-lover-outfit-giver" data-character-id="${escapeHtml(character.id)}">
    ...
    if (modal.type === 'error-retry') {
      const textPresetMode = state.runtime?.meta?.textPresetMode === 'builtin' ? 'builtin' : 'tavern';
      const canSwitchTextPreset = Boolean(state.runtime) && modal.title === '剧情生成失败';
      const nextTextPresetMode = textPresetMode === 'builtin' ? 'tavern' : 'builtin';
      const canRetryWithBuiltInPreset = textPresetMode === 'tavern' && /当前正在使用酒馆预设/.test(String(modal.message || ''));
      return `
        <div class="modal-backdrop">
          <div class="modal">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <pre>${escapeHtml(modal.message)}</pre>
              ${canSwitchTextPreset ? `<p>当前预设：${textPresetMode === 'builtin' ? '角色卡预设' : '酒馆预设'}。切换后点击“重试”重新生成。</p>` : ''}
              <div class="modal-actions inline-actions">
                ...
                ${canSwitchTextPreset ? `<button class="secondary" data-action="set-text-preset-mode" data-mode="${nextTextPresetMode}">${nextTextPresetMode === 'tavern' ? '切换为酒馆预设' : '切换为角色卡预设'}</button>` : ''}
          ...
          <div class="modal">
            ...
            <div class="modal-body">
              <div class="topbar">
                ...
                <strong>${escapeHtml(formatCampaignMonth(month))}</strong>
    ...
    if (modal.type === 'outfits') {
      const outfits = state.runtime?.outfits || [];
      return `
        <div class="modal-backdrop">
          <div class="modal">
            <div class="modal-header">
                ...
                ${outfits.length ? outfits.map((item) => {
                  ...
                  return `
                    <div class="outfit-gallery-card">
                      ...
                      <button class="secondary" data-action="retry-outfit" data-outfit-id="${item.id}" ${imageGenerationReady ? '' : 'disabled'}>${imageGenerationReady ? '重新生成礼服图片' : '礼服图片生成中…'}</button>
                    </div>
                  `;
                }).join('') : '<div class="muted-box">暂无礼服记录。</div>'}
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="modal-body">
              ...
              <div class="date-picker-grid">
                ${modal.characters.map((character) => {
                  ...
                  return `
                    <button class="date-picker-card" data-action="toggle-chocolate-character" data-character-id="${character.id}" aria-pressed="${selected}">
                      <strong>${escapeHtml(character.name)}</strong>
                      <small>${escapeHtml(character.identity || '无身份')}</small>
                      <small>${received ? '情人节曾送你巧克力' : '情人节未送你巧克力'}</small>
                      <span class="pill" data-chocolate-selection-label>${selected ? '本次送出' : '本次不送'}</span>
                    </button>
                  `;
  ...
  function render() {
    ...
    if (state.ui.page === 'merge-game') {
      // A story or background update can redraw a cell while it owns pointer
      // capture. The detached cell may never deliver pointerup/pointercancel,
      ...
      if (hasMergeModal || state.ui.infoModalOpen) {
        ...
        app.innerHTML = renderMergeGame() + renderAiLoading() + renderStorageLoading();
      } else {
  ...
  function renderStorageLoading() {
    ...
    return `
      <div class="loading-backdrop" role="status" aria-live="polite" aria-busy="true">
        <div class="loading-panel">
          <div class="loading-spinner" aria-hidden="true"></div>
          <div class="subtle">${escapeHtml(state.ui.storageLoading.message || '请稍候…')}</div>
        </div>
      </div>
    `;
  }
  ...
  async function initializeGame() {
    ...
    if (pruneStoredRuntimeRuleFields()) {
      await flushChatStorage().catch(() => null);
    }
    ...
    if (state.runtime) {
      ...
      if (recoveredAssets.interruptedCount > 0) {
        state.ui.status = `检测到 ${recoveredAssets.interruptedCount} 个被刷新中断的头像或礼服任务，已停止自动重发；请在角色页或礼服页手动重新生成。`;
        state.ui.statusTone = 'warning';
      }
      state.ui.page = 'schedule';
  ...
  function submitApplication(form) {
    ...
    state.ui.playerDescriptionDraft = null;
    saveCurrentRuntime();
    saveAutoSlot();
    ...
    try {
      switch (action) {
        ...
        case 'retry-with-builtin-preset':
          {
            ...
            if (state.runtime) {
              ...
              saveTextPresetModePreference('builtin');
              saveCurrentRuntime();
            }
            closeModal();
            if (retry) {
        ...
        case 'set-text-preset-mode': {
          ...
          saveTextPresetModePreference(mode);
          saveCurrentRuntime();
        ...
        case 'save-player-description': {
          const description = String(app.querySelector('#playerDescription')?.value ?? '').trim();
          if (!description) {
            throw new Error('主角身份与性格不能为空。');
          }
          const previous = state.runtime.meta.playerDescription;
          state.runtime.meta.playerDescription = description;
          if (!saveCurrentRuntime()) {
            state.runtime.meta.playerDescription = previous;
            throw new Error('主角设定未能保存，请检查存储空间后重试。');
          }
          state.ui.playerDescriptionDraft = null;
          await flushChatStorage();
          setStatus('主角设定已保存，下一次剧情生成会使用新内容。', 'success');
          render();
          return;
        }
        case 'reset-player-description': {
          const previous = state.runtime.meta.playerDescription;
          delete state.runtime.meta.playerDescription;
          if (!saveCurrentRuntime()) {
            state.runtime.meta.playerDescription = previous;
            throw new Error('恢复默认设定失败，请检查存储空间后重试。');
          }
          state.ui.playerDescriptionDraft = null;
          await flushChatStorage();
          setStatus('主角设定已恢复默认。', 'success');
          render();
          return;
        }
        case 'save-slot': {
          const slot = Number(button.dataset.slot);
          const ok = await runStorageOperation('存档中', async () => {
            const saved = saveManualSlot(slot);
            if (!saved) {
              return false;
            }
        ...
        case 'load-slot': {
          const slot = Number(button.dataset.slot);
          await runStorageOperation('读档中', async () => {
            const saved = loadManualSlot(slot);
            if (!saved?.runtime) {
            ...
            const slotImages = await loadImagesFromIDB(`slot${slot}`);
        ...
        case 'retry-avatar':
          ...
          return;
        case 'retry-outfit':
          if (await queueOutfitImageGeneration(button.dataset.outfitId)) {
            setStatus('已重新提交礼服图片生成请求。', 'success');
          }
          return;
        case 'pick-date':
        ...
        case 'toggle-chocolate-character':
          if (state.ui.modal?.type === 'chocolate-picker') {
            ...
            const selectionLabel = button.querySelector('[data-chocolate-selection-label]');
            if (selectionLabel) {
              selectionLabel.textContent = isSelected ? '本次送出' : '本次不送';
            }
          }
          return;
  ...
  function cancelActiveMergeDrag() {
    if (!mergeDrag) return;
    const { captured, target, pointerId } = mergeDrag;
    mergeDrag = null;
    if (state.mergeGame) state.mergeGame.generationMotherId = null;
    if (captured && target && pointerId != null) {
      try {
        target.releasePointerCapture?.(pointerId);
      } catch {
        // A rerender may already have detached the capturing cell.
      }
    }
    removeMergeClone();
  }
  ...
  app.addEventListener('pointercancel', (event) => {
    if (!mergeDrag || event.pointerId !== mergeDrag.pointerId) return;
    cancelActiveMergeDrag();
  });

  // Pointer events from a detached capture target may not bubble through app.
  window.addEventListener('pointerup', (event) => {
    if (mergeDrag && event.pointerId === mergeDrag.pointerId) cancelActiveMergeDrag();
  });
  window.addEventListener('pointercancel', (event) => {
    if (mergeDrag && event.pointerId === mergeDrag.pointerId) cancelActiveMergeDrag();
  });
  window.addEventListener('blur', cancelActiveMergeDrag);

  app.addEventListener('input', (event) => {
    if (event.target.id === 'playerDescription') {
      state.ui.playerDescriptionDraft = event.target.value;
    }
  });
