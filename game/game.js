(function () {
  ...
  const PLACEHOLDER_AVATAR = 'placeholder-avatar.svg?build=20260917000737';
  const DAILY_COST = 25;
  ...
  const MERGE_CHAINS = [
    {
      id: 1, name: '构思链', motherSvg: '1-0.svg?build=20260917000737', motherName: '构思',
      pieces: [
        { level: 1, svg: '1-1.svg?build=20260917000737', name: '灵感微光' },
        { level: 2, svg: '1-2.svg?build=20260917000737', name: '零散想法' },
        { level: 3, svg: '1-3.svg?build=20260917000737', name: '初步构思' },
        { level: 4, svg: '1-4.svg?build=20260917000737', name: '核心论点' },
        { level: 5, svg: '1-5.svg?build=20260917000737', name: '论文大纲' },
        { level: 6, svg: '1-6.svg?build=20260917000737', name: '引言初稿' },
        { level: 7, svg: '1-7.svg?build=20260917000737', name: '引言定稿' }
      ]
    },
    {
      id: 2, name: '文献链', motherSvg: '2-0.svg?build=20260917000737', motherName: '文献',
      pieces: [
        { level: 1, svg: '2-1.svg?build=20260917000737', name: '阅读闪念' },
        { level: 2, svg: '2-2.svg?build=20260917000737', name: '文献摘录' },
        { level: 3, svg: '2-3.svg?build=20260917000737', name: '综述片段' },
        { level: 4, svg: '2-4.svg?build=20260917000737', name: '文献综述' },
        { level: 5, svg: '2-5.svg?build=20260917000737', name: '理论框架' },
        { level: 6, svg: '2-6.svg?build=20260917000737', name: '方法初稿' },
        { level: 7, svg: '2-7.svg?build=20260917000737', name: '方法定稿' }
      ]
    },
    {
      id: 3, name: '实证链', motherSvg: '3-0.svg?build=20260917000737', motherName: '实证',
      pieces: [
        { level: 1, svg: '3-1.svg?build=20260917000737', name: '数据直觉' },
        { level: 2, svg: '3-2.svg?build=20260917000737', name: '实验记录' },
        { level: 3, svg: '3-3.svg?build=20260917000737', name: '分析图表' },
        { level: 4, svg: '3-4.svg?build=20260917000737', name: '结果汇总' },
        { level: 5, svg: '3-5.svg?build=20260917000737', name: '结果解读' },
        { level: 6, svg: '3-6.svg?build=20260917000737', name: '结果初稿' },
        { level: 7, svg: '3-7.svg?build=20260917000737', name: '结果定稿' }
      ]
    },
    {
      id: 4, name: '思辨链', motherSvg: '4-0.svg?build=20260917000737', motherName: '思辨',
      pieces: [
        { level: 1, svg: '4-1.svg?build=20260917000737', name: '讨论灵感' },
        { level: 2, svg: '4-2.svg?build=20260917000737', name: '批判笔记' },
        { level: 3, svg: '4-3.svg?build=20260917000737', name: '逻辑论证' },
        { level: 4, svg: '4-4.svg?build=20260917000737', name: '讨论要点' },
        { level: 5, svg: '4-5.svg?build=20260917000737', name: '结论雏形' },
        { level: 6, svg: '4-6.svg?build=20260917000737', name: '讨论初稿' },
        { level: 7, svg: '4-7.svg?build=20260917000737', name: '讨论定稿' }
      ]
    }
  ];
  ...
  const MERGE_BIZ_CHAINS = [
    {
      id: 1, name: '机会', motherSvg: 'g1-0.svg?build=20260917000737', motherName: '机会',
      pieces: [
        { level: 1, svg: 'g1-1.svg?build=20260917000737', name: '市场杂闻' },
        { level: 2, svg: 'g1-2.svg?build=20260917000737', name: '用户抱怨' },
        { level: 3, svg: 'g1-3.svg?build=20260917000737', name: '需求碎片' },
        { level: 4, svg: 'g1-4.svg?build=20260917000737', name: '目标用户画像' },
        { level: 5, svg: 'g1-5.svg?build=20260917000737', name: '需求验证报告' },
        { level: 6, svg: 'g1-6.svg?build=20260917000737', name: '市场规模预估' },
        { level: 7, svg: 'g1-7.svg?build=20260917000737', name: '市场分析篇' }
      ]
    },
    {
      id: 2, name: '产品', motherSvg: 'g2-0.svg?build=20260917000737', motherName: '产品',
      pieces: [
        { level: 1, svg: 'g2-1.svg?build=20260917000737', name: '产品想法' },
        { level: 2, svg: 'g2-2.svg?build=20260917000737', name: '功能清单' },
        { level: 3, svg: 'g2-3.svg?build=20260917000737', name: '核心功能原型' },
        { level: 4, svg: 'g2-4.svg?build=20260917000737', name: '价值主张' },
        { level: 5, svg: 'g2-5.svg?build=20260917000737', name: '最小可行产品计划' },
        { level: 6, svg: 'g2-6.svg?build=20260917000737', name: '技术路线图' },
        { level: 7, svg: 'g2-7.svg?build=20260917000737', name: '解决方案篇' }
      ]
    },
    {
      id: 3, name: '商业', motherSvg: 'g3-0.svg?build=20260917000737', motherName: '商业',
      pieces: [
        { level: 1, svg: 'g3-1.svg?build=20260917000737', name: '盈利点子' },
        { level: 2, svg: 'g3-2.svg?build=20260917000737', name: '收入来源列表' },
        { level: 3, svg: 'g3-3.svg?build=20260917000737', name: '成本结构分析' },
        { level: 4, svg: 'g3-4.svg?build=20260917000737', name: '定价策略' },
        { level: 5, svg: 'g3-5.svg?build=20260917000737', name: '客户关系策略' },
        { level: 6, svg: 'g3-6.svg?build=20260917000737', name: '核心伙伴设想' },
        { level: 7, svg: 'g3-7.svg?build=20260917000737', name: '商业模式篇' }
      ]
    },
    {
      id: 4, name: '执行', motherSvg: 'g4-0.svg?build=20260917000737', motherName: '执行',
      pieces: [
        { level: 1, svg: 'g4-1.svg?build=20260917000737', name: '创始初心' },
        { level: 2, svg: 'g4-2.svg?build=20260917000737', name: '团队雏形' },
        { level: 3, svg: 'g4-3.svg?build=20260917000737', name: '关键里程碑' },
        { level: 4, svg: 'g4-4.svg?build=20260917000737', name: '资源配置计划' },
        { level: 5, svg: 'g4-5.svg?build=20260917000737', name: '风险预案' },
        { level: 6, svg: 'g4-6.svg?build=20260917000737', name: '财务预测' },
        { level: 7, svg: 'g4-7.svg?build=20260917000737', name: '落地路线图' }
      ]
    }
  ];
  ...
  function formatStoryContentHtml(value) {
    ...
    while ((match = pattern.exec(source)) !== null) {
      ...
      if (match[1] !== undefined || match[2] !== undefined) {
        ...
        html += `<span class="story-muted-inline">${escapeHtml(match[3])}</span>`;
      }
  ...
  function patchRuntimeDefaults(runtime) {
    ...
    for (const plan of Object.values(runtime.schedulePlans)) {
      ...
      if (plan.kind === 'activity') {
        plan.fixed = isLockedScheduleActivity(normalizeActivityLabel(plan.activity || plan.label || ''));
      }
    }
  ...
  function parseLooseCharacterJson(text) {
    ...
    const objectText = start !== -1 && end !== -1 && end > start
      ...
      : sanitized;
    const normalized = normalizeLooseJsonText(objectText)
      .replace(/,\s*([}\]])/g, '$1');
    try {
  ...
  function extractTag(text, tag) {
    ...
    return match ? sanitizeAiText(match[1]).trim() : '';
  }

  function extractAllTags(text, tag) {
    return [...String(text || '').matchAll(new RegExp(`<${tag}>([\\s\\S]*?)</${tag}>`, 'gi'))]
      .map((match) => sanitizeAiText(match[1]).trim())
      .filter(Boolean);
  }

  function parseLooseCharacterList(text) {
    const source = sanitizeJsonBlock(text);
    if (!source) {
      return [];
    }
    const normalized = normalizeLooseJsonText(source);
    try {
      ...
      // Fall through to object block parsing.
    }
    const objectBlocks = splitTopLevelJsonObjects(sanitizeJsonBlock(source));
    if (objectBlocks.length) {
      return objectBlocks.map((item) => parseLooseCharacterJson(item));
    }
    return [parseLooseCharacterJson(source)];
  }

  function parseEventOutput(text) {
    const sanitizedText = sanitizeAiText(text);
    const infoBlock = extractTag(sanitizedText, 'info_block');
    const content = extractTag(sanitizedText, 'content');
    const newHistory = extractTag(sanitizedText, 'newHistory');
    const newLocation = extractTag(sanitizedText, 'newLocation');
    const newCharacterTexts = extractAllTags(sanitizedText, 'newCharacter');
    const newClothTexts = extractAllTags(sanitizedText, 'newCloth');
    if (!infoBlock || !content || !newHistory) {
      throw new Error('AI 返回缺少必要标签，请重试。');
    }
    const newCharacters = newCharacterTexts
      .flatMap((item) => parseLooseCharacterList(item))
  ...
  async function maybeHandlePovertyEvent(runtime, dateText) {
    ...
    if (runtime.flags.povertyAidCount <= 0) {
      const hasPresident = runtime.characters.some((character) => String(character.identity || '').includes('学生会长') || String(character.affiliation || '').includes('学生会'));
      await executeStoryEvent(hasPresident ? '勤工助学事件已有学生会长版' : '勤工助学事件没有学生会长版', dateText, {
        characterIds: runtime.characters.map((item) => item.id)
      });
  ...
  function formatChaptersForPrompt(runtime) {
    ...
    return chapters.length
      ? chapters.map((chapter) => `<info_block>\n${chapter.infoBlock}\n</info_block>\n<content>\n${chapter.content}\n</content>`).join('\n\n')
      : '无';
  }
  ...
  function getDateInviteDirectiveText(options = {}) {
    if (options.inviteOrigin === 'player') {
      return '本次约会是<user>主动邀约，之有五百块预算，所以不会去太贵的约会项目。';
    }
  ...
  function resolveTutorCreatedCharacters(newCharacters = [], eventName = '') {
    ...
    if (eventName === '第一次做家教事件') {
      const student = studentByIdentity
        || createdCharacters.find((character) => character.age > 0 && character.age < 18)
        || createdCharacters[0]
        || null;
  ...
  function resolveEventCharacterIds(runtime, eventName, dateText, options = {}) {
    ...
    if (rule.includes('学生会长')) {
      const candidate = pickRandom(candidates.filter((character) => character.identity.includes('学生会长') || character.affiliation.includes('学生会')));
      return uniqueCharacterIds([candidate?.id]);
    }
    ...
    if (rule.includes('角色列表里任意一个低<user>一届的本校学生')) {
      const candidate = pickRandom(runtime.characters.filter((character) => hasAffiliation(character, '本校学生') && character.grade === Math.max(1, currentYear - 1)));
      return uniqueCharacterIds([candidate?.id]);
    }
...
${promptContextLines.join('\n')}`;
  ...
  async function executeStoryEvent(eventName, dateText, options = {}) {
    ...
    while (true) {
      try {
        ...
        return applyEventResult(state.runtime, dateText, parsed, getEventSpec(eventName), context, text, fullPromptJson, {
          ...options,
        ...
        retryCount++;
        await waitForErrorRetryModal('剧情生成失败', formatAiErrorMessage(error));
      }
    }
  }
    ...
    if (inviteOrigin === 'player') {
      ...
      if (!success) {
        ...
        openModal({
          type: 'text',
          title: '邀约失败',
          message: `${character.name}这次没有答应，按钮会在本周结束后恢复。`
        });
        return;
      }
    }
  ...
  async function executeReview(runtime, plan, dateText) {
    const course = runtime.courses[plan.courseId];
    updatePlayerFatigue(runtime, 5);
    updateCourseStudyProgress(course, 5);
  ...
  async function executeAddDay(runtime, dateText, weekDates) {
    ...
    const t = state.ui.execTrace;
    try {
      t && t.push(`  pre:${formatMonthDay(dateText)}`);
      t && setStatus(t.join('\n'), 'warning');
      ...
      if (!hospitalized && !skipPlan) {
        t && t.push(`  plan:${formatMonthDay(dateText)}`);
        t && setStatus(t.join('\n'), 'warning');
      ...
      while (handledChapterCount < deferredChapterIds.length) {
        t && t.push(`  ch:${handledChapterCount + 1}/${deferredChapterIds.length}`);
        t && setStatus(t.join('\n'), 'warning');
        await waitForChapterModal(deferredChapterIds[handledChapterCount]);
        handledChapterCount += 1;
      }
      t && t.push(`  post:${formatMonthDay(dateText)}`);
      t && setStatus(t.join('\n'), 'warning');
  ...
  async function finalizeWeek(runtime, executedWeekDates) {
    ...
    if (shouldFinalize && (!nextTerm || nextTerm.isBreak || nextTerm.id !== previousTerm.id)) {
      clearCharacterGlobalFlag(runtime, '做助教认识的学弟');
  ...
  async function executeCurrentWeek() {
    ...
    const trace = [`待执行: ${pendingDates.length} 天 (${weekDates.map(formatMonthDay).join(', ')})`];
    state.ui.execTrace = trace;
    setStatus(trace.join('\n'), 'warning');
    ...
    try {
      ...
      for (const dateText of pendingDates) {
        trace.push(`→ ${formatMonthDay(dateText)} 开始`);
        setStatus(trace.join('\n'), 'warning');
        try {
          await executeAddDay(runtime, dateText, weekDates);
        } catch (error) {
          trace.push(`✗ ${formatMonthDay(dateText)} 错误: ${error.message || '未知错误'}`);
          setStatus(trace.join('\n'), 'error');
          break;
        }
        executedDates.push(dateText);
        runtime.player.currentDate = addDays(dateText, 1); // 14. 下一天已排定则自动继续
        trace.push(`✓ ${formatMonthDay(dateText)} 完成`);
        setStatus(trace.join('\n'), 'warning');
        if (runtime.phase === 'ended') {
          trace.push(`阶段变为 ended，停止执行`);
          break;
        }
      }
      ...
      if (runtime.phase === 'ended' && runtime.meta.ending?.type === 'graduation') {
        trace.push('正在把毕业资料同步到当前对话世界书…');
        setStatus(trace.join('\n'), 'warning');
        const worldbookExport = await ensureGraduationWorldbookExport(runtime, false);
        if (worldbookExport?.status === 'success') {
          trace.push(`✓ 世界书已完成毕业同步：${worldbookExport.worldbookName}`);
        } else if (worldbookExport?.status === 'failed') {
          trace.push(`⚠ 世界书暂未完成同步：${worldbookExport.error}`);
        }
      }
      const savedRuntime = saveCurrentRuntime();
      const savedAuto = saveAutoSlot();
      if (!savedRuntime || !savedAuto) {
        trace.push('结果: 本周执行完毕，但存档写入失败。');
        state.ui.execTrace = trace;
        render();
      } else if (runtime.phase !== 'ended') {
        trace.push(executedDates.length < weekDates.length ? `结果: 完成 ${executedDates.length}/${weekDates.length} 天` : '结果: 本周全部完成');
        setStatus(trace.join('\n'), executedDates.length < weekDates.length ? 'warning' : 'success');
      } else {
        trace.push('结果: 进入结局');
        setStatus(trace.join('\n'), 'warning');
      }
  ...
  function cleanupStaleMergeTasks(mode, savedTasks) {
    ...
    var activeCourseIds = getActiveHomeworkCourses().map(function (c) { return c.courseId; });
    return savedTasks.filter(function (t) { return activeCourseIds.includes(t.courseId); });
  }
    ...
    if (saved && Array.isArray(saved.board) && saved.board.length === MERGE_BOARD_SIZE && (saved.mode === mode || (!saved.mode && mode === 'homework'))) {
      ...
      if (mode === 'biz' && state.runtime && !state.runtime.flags.firstOpeningCeremonyTriggered) {
        ...
        state.mergeGame.tasks = [{
          ...
          courseName: '创业企划书',
          isThesis: false,
          requiredPieces: [{ chainId: 1, level: 2, svg: 'g1-2.svg?build=20260917000737', name: '用户抱怨' }]
        }];
      } else {
        refreshMergeTasks();
      }
  ...
  function renderMergeGameContent() {
    ...
    for (let i = 0; i < MERGE_BOARD_SIZE; i++) {
      ...
      if (piece) {
        ...
        cellContent = `<img src="${svg}" class="${pieceClass}${animClass}"${imgStyle} data-action="merge-piece-click" data-cell="${i}" alt="${pInfo ? pInfo.name : ''}" title="${pInfo ? pInfo.name : ''}">`;
      }
    ...
    return `
      ...
      ${tasksHtml}
      <div class="merge-board" style="grid-template-columns:repeat(${MERGE_BOARD_COLS},1fr);grid-template-rows:repeat(${MERGE_BOARD_ROWS},1fr);">
        ${boardHtml}
      </div>
      <div class="merge-desc-area">${descHtml}</div>
      ${tutorialHtml}
    `;
  }
      ...
      <div class="panel section">
        ...
        <form id="applicationForm" class="grid-2" style="margin-top:18px;">
          <div class="field">
            ...
            <input id="playerName" name="name" maxlength="4" placeholder="请输入主角姓名" required />
          </div>
          <div class="field">
            <label>性别 / 年龄</label>
    ...
    return `
      <div class="panel section">
        ...
        <div class="muted-box" style="margin-top:18px;">
          ...
          角色资料与主角履历可在酒馆世界书编辑器中自由修改；下一次剧情生成会读取修改后的内容。
        </div>
  ...
  function render() {
    ...
    if (state.ui.modal?.type === 'chapter' && typeof window !== 'undefined') {
      window.requestAnimationFrame(() => {
        ...
        if (modalBody) {
          modalBody.scrollTop = Number(state.ui.modal?.scrollTop || 0);
        }
      });
    }
  }
    ...
    try {
      switch (action) {
        ...
        case 'open-image-settings': {
          const bridge = getTavernBridge();
          if (!bridge || typeof bridge.openImageSettings !== 'function') {
            throw new Error('没有找到酒馆生图设置桥接接口。');
          }
  ...
  function getMergeCellFromBoard(boardEl, clientX, clientY) {
    ...
    const col = Math.floor((x / rect.width) * MERGE_BOARD_COLS);
    const row = Math.floor((y / rect.height) * MERGE_BOARD_ROWS);
    if (col < 0 || col >= MERGE_BOARD_COLS || row < 0 || row >= MERGE_BOARD_ROWS) return -1;
    return row * MERGE_BOARD_COLS + col;
  }
  ...
  app.addEventListener('pointerdown', (event) => {
    ...
    mergeDrag = { cell, startX: event.clientX, startY: event.clientY, moved: false, pointerId: event.pointerId, target: event.target };
  });
  ...
  app.addEventListener('pointerup', (event) => {
    ...
    if (mergeDrag.moved) {
      ...
      if (boardEl) {
        ...
        if (targetCell >= 0 && targetCell !== mergeDrag.cell) {
          handleMergeDrop(mergeDrag.cell, targetCell);
        }
      }
      render();
      setTimeout(function () { saveCurrentRuntime(); }, 0);
  ...
  app.addEventListener('pointercancel', () => {
    if (mergeDrag?.target && mergeDrag.pointerId != null) {
  ...
  app.addEventListener('scroll', (event) => {
    ...
    if (!(target instanceof HTMLElement) || !target.classList.contains('modal-body')) {
      return;
    }
