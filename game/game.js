(function () {
  ...
  const PLACEHOLDER_AVATAR = 'placeholder-avatar.svg?build=20260917014334';
  const DAILY_COST = 25;
  ...
  const MERGE_CHAINS = [
    {
      id: 1, name: '构思链', motherSvg: '1-0.svg?build=20260917014334', motherName: '构思',
      pieces: [
        { level: 1, svg: '1-1.svg?build=20260917014334', name: '灵感微光' },
        { level: 2, svg: '1-2.svg?build=20260917014334', name: '零散想法' },
        { level: 3, svg: '1-3.svg?build=20260917014334', name: '初步构思' },
        { level: 4, svg: '1-4.svg?build=20260917014334', name: '核心论点' },
        { level: 5, svg: '1-5.svg?build=20260917014334', name: '论文大纲' },
        { level: 6, svg: '1-6.svg?build=20260917014334', name: '引言初稿' },
        { level: 7, svg: '1-7.svg?build=20260917014334', name: '引言定稿' }
      ]
    },
    {
      id: 2, name: '文献链', motherSvg: '2-0.svg?build=20260917014334', motherName: '文献',
      pieces: [
        { level: 1, svg: '2-1.svg?build=20260917014334', name: '阅读闪念' },
        { level: 2, svg: '2-2.svg?build=20260917014334', name: '文献摘录' },
        { level: 3, svg: '2-3.svg?build=20260917014334', name: '综述片段' },
        { level: 4, svg: '2-4.svg?build=20260917014334', name: '文献综述' },
        { level: 5, svg: '2-5.svg?build=20260917014334', name: '理论框架' },
        { level: 6, svg: '2-6.svg?build=20260917014334', name: '方法初稿' },
        { level: 7, svg: '2-7.svg?build=20260917014334', name: '方法定稿' }
      ]
    },
    {
      id: 3, name: '实证链', motherSvg: '3-0.svg?build=20260917014334', motherName: '实证',
      pieces: [
        { level: 1, svg: '3-1.svg?build=20260917014334', name: '数据直觉' },
        { level: 2, svg: '3-2.svg?build=20260917014334', name: '实验记录' },
        { level: 3, svg: '3-3.svg?build=20260917014334', name: '分析图表' },
        { level: 4, svg: '3-4.svg?build=20260917014334', name: '结果汇总' },
        { level: 5, svg: '3-5.svg?build=20260917014334', name: '结果解读' },
        { level: 6, svg: '3-6.svg?build=20260917014334', name: '结果初稿' },
        { level: 7, svg: '3-7.svg?build=20260917014334', name: '结果定稿' }
      ]
    },
    {
      id: 4, name: '思辨链', motherSvg: '4-0.svg?build=20260917014334', motherName: '思辨',
      pieces: [
        { level: 1, svg: '4-1.svg?build=20260917014334', name: '讨论灵感' },
        { level: 2, svg: '4-2.svg?build=20260917014334', name: '批判笔记' },
        { level: 3, svg: '4-3.svg?build=20260917014334', name: '逻辑论证' },
        { level: 4, svg: '4-4.svg?build=20260917014334', name: '讨论要点' },
        { level: 5, svg: '4-5.svg?build=20260917014334', name: '结论雏形' },
        { level: 6, svg: '4-6.svg?build=20260917014334', name: '讨论初稿' },
        { level: 7, svg: '4-7.svg?build=20260917014334', name: '讨论定稿' }
      ]
    }
  ];
  ...
  const MERGE_BIZ_CHAINS = [
    {
      id: 1, name: '机会', motherSvg: 'g1-0.svg?build=20260917014334', motherName: '机会',
      pieces: [
        { level: 1, svg: 'g1-1.svg?build=20260917014334', name: '市场杂闻' },
        { level: 2, svg: 'g1-2.svg?build=20260917014334', name: '用户抱怨' },
        { level: 3, svg: 'g1-3.svg?build=20260917014334', name: '需求碎片' },
        { level: 4, svg: 'g1-4.svg?build=20260917014334', name: '目标用户画像' },
        { level: 5, svg: 'g1-5.svg?build=20260917014334', name: '需求验证报告' },
        { level: 6, svg: 'g1-6.svg?build=20260917014334', name: '市场规模预估' },
        { level: 7, svg: 'g1-7.svg?build=20260917014334', name: '市场分析篇' }
      ]
    },
    {
      id: 2, name: '产品', motherSvg: 'g2-0.svg?build=20260917014334', motherName: '产品',
      pieces: [
        { level: 1, svg: 'g2-1.svg?build=20260917014334', name: '产品想法' },
        { level: 2, svg: 'g2-2.svg?build=20260917014334', name: '功能清单' },
        { level: 3, svg: 'g2-3.svg?build=20260917014334', name: '核心功能原型' },
        { level: 4, svg: 'g2-4.svg?build=20260917014334', name: '价值主张' },
        { level: 5, svg: 'g2-5.svg?build=20260917014334', name: '最小可行产品计划' },
        { level: 6, svg: 'g2-6.svg?build=20260917014334', name: '技术路线图' },
        { level: 7, svg: 'g2-7.svg?build=20260917014334', name: '解决方案篇' }
      ]
    },
    {
      id: 3, name: '商业', motherSvg: 'g3-0.svg?build=20260917014334', motherName: '商业',
      pieces: [
        { level: 1, svg: 'g3-1.svg?build=20260917014334', name: '盈利点子' },
        { level: 2, svg: 'g3-2.svg?build=20260917014334', name: '收入来源列表' },
        { level: 3, svg: 'g3-3.svg?build=20260917014334', name: '成本结构分析' },
        { level: 4, svg: 'g3-4.svg?build=20260917014334', name: '定价策略' },
        { level: 5, svg: 'g3-5.svg?build=20260917014334', name: '客户关系策略' },
        { level: 6, svg: 'g3-6.svg?build=20260917014334', name: '核心伙伴设想' },
        { level: 7, svg: 'g3-7.svg?build=20260917014334', name: '商业模式篇' }
      ]
    },
    {
      id: 4, name: '执行', motherSvg: 'g4-0.svg?build=20260917014334', motherName: '执行',
      pieces: [
        { level: 1, svg: 'g4-1.svg?build=20260917014334', name: '创始初心' },
        { level: 2, svg: 'g4-2.svg?build=20260917014334', name: '团队雏形' },
        { level: 3, svg: 'g4-3.svg?build=20260917014334', name: '关键里程碑' },
        { level: 4, svg: 'g4-4.svg?build=20260917014334', name: '资源配置计划' },
        { level: 5, svg: 'g4-5.svg?build=20260917014334', name: '风险预案' },
        { level: 6, svg: 'g4-6.svg?build=20260917014334', name: '财务预测' },
        { level: 7, svg: 'g4-7.svg?build=20260917014334', name: '落地路线图' }
      ]
    }
  ];
    ...
    if (saved && Array.isArray(saved.board) && saved.board.length === MERGE_BOARD_SIZE && (saved.mode === mode || (!saved.mode && mode === 'homework'))) {
      ...
      if (mode === 'biz' && state.runtime && !state.runtime.flags.firstOpeningCeremonyTriggered) {
        ...
        state.mergeGame.tasks = [{
          ...
          courseName: '创业企划书',
          isThesis: false,
          requiredPieces: [{ chainId: 1, level: 2, svg: 'g1-2.svg?build=20260917014334', name: '用户抱怨' }]
        }];
      } else {
        refreshMergeTasks();
      }
