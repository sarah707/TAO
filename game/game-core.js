(function (global) {
  ...
  const CHARACTER_FIELD_ALIASES = Object.freeze({
    ...
    性格动力与社交类型: ['性格动力与社交类型', '性格动力', '社交类型', 'socialDynamics', 'social_dynamics'],
    说话方式与台词示例: ['说话方式与台词示例', '说话方式', '台词示例', 'speechStyle', 'speech_style'],
    核心特质: ['核心特质', '性格', 'traits', 'personality'],
    人物小传: ['人物小传', '背景', 'bio', 'biography'],
    在家族企业或政府部分的职位: ['在家族企业或政府部分的职位', '家族企业或政府职位', '家族职位', 'familyPosition', 'family_position'],
    爱好: ['爱好', 'hobbies'],
